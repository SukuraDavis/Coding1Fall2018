...
namespace JRomansIntroRecap
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Do you live in Mexico? Use y or n.");
            ...
            if (country[0].ToString().ToLower() == "y" && age >= 18)
            {
            ...
            else if (country[0].ToString().ToLower() == "n" && age >= 16)
            {
                Console.WriteLine("You can legally drive");
            }
            ...
            int index = 0;
            //while index < 10 Console writeline index, incredment index
            while (index < 10)
            {
            ...
            index = 0;
            //while index < 0 console writeline index, incredment index
            while (index < 0)
            {
                Console.WriteLine(index + 1);
                break;
            ...
            //Reset index variable to 0
            index = 0;
            //do-while index < 10 console writeline index, incredment index
            do
            {
                Console.WriteLine(index + 1);
                break;
            ...
            //reset index variable to 0
            index = 0;
            //do-while index < 0 console writeline index, incredment index
            do
            {
                Console.WriteLine(index + 1);
                break;
            ...
            stringArray = "firstName|lastName|city|state|country".Split('|');
            ...
            for (int i = stringArray.Length + 1; i < 5; i++)
            {
            ...
            string[] stringArray2 = new string[3] { "buddy", "guy", "Friend" };
            ...
            for (int i = intArray2.Length; i >= 0; i--)
            {
                Console.WriteLine(intArray2);
            }
            ...
            for (int i = stringArray2.Length; i >= 0; i--)
            {
                Console.WriteLine(stringArray2);
            }
